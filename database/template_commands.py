...
food2 = Food(foodId=2, cookId=1, locationLong=103.91, locationLat=1.32, price=4800, quota=4, datetime="24th Jan 2018, 1800hrs", cuisine='Western Food', description='I am a chef of Western Food, I used to work for the Gordon Ramsay. We will be having some salads as starters, and some beef sirloin as a main. I will prepare the cuts to your liking of doneness. We will finish with a lava cake and some champaigne. This meal is best served with a family or couple.', title='Dining with a Professional Chef')
